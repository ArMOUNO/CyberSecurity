...
const imageDesignDot = () => {
    const imageDesignDotContent = document.getElementById("imageDesignDot");
...
const imageDesignDotBar = () => {
  return `
     <section class="flex mt-[270px] md:mt-0 flex-col-reverse md:flex-row items-center  h-[500px] pt-16 justify-between gap-10 text-blue-950">
        ...
        <div class="lg:w-fit flex flex-col py-6 items-start justify-start font-bold">
          ...
          <div class="py-10 flex justify-start">
            <p class="lg:text-3xl md:text-xl text-start">
