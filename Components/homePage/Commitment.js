...
const whatWeDo = () => {
    const whatWeDocontent = document.getElementById("Commitment");
...
const whatWeDoBar = () => {
  return `
<section class="flex justify-center md:mt-[50px] lg:mt-[170px]">
          <div class="  h-fit">
            <p class="lg:text-3xl md:mb-[100px] thinText md:text-2xl bolder text-xl text-center  pb-4">Our Commitment to Excellence</p>
    <div class="grid gap-5 lg:gap-20  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pt-12 text-lg justify-center px-4 lg:px-16 z-40">
      <div class="shadow z-10 thinText w-[340px] md:w-[377px] h-[270px] flex flex-col items-center justify-center">
      ...
      <div class="shadow thinText z-10  w-[340px] md:w-[377px] h-[270px] flex flex-col items-center justify-center">
   ...
   <img id="largeCircle" class="w-[190px]  z-0 top-[-60px] left-[200px] absolute hidden lg:block" src="../assets/images/circlehalf.png" alt="" />

      <div class="shadow thinText  w-[340px] md:w-[377px] h-[270px] flex flex-col items-center justify-center">
        <img class="w-24  pt-5" src="/assets/images/quality.png" alt="">
