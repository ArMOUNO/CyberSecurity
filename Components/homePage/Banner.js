              ...
              <nav class=" bg-white h-10 md:h-12  shadow-green-600 flex items-center justify-between">
                ...
                <ul class="hide-on-small-only gap-6 flex pr-3 ">
                  <li class="navDark flex items-center">
                    <a href="index.html" class="text-gray-600 relative text-[14px] hover:text-cyan-500 transform hover:scale-105 font-bold transition-all duration-300 ease-in-out">
                      Home
                      <!-- Bottom Border Span -->
                      <span class="absolute top-0 left-0 right-0 -z-10 border-b-2 border-cyan-400 rounded-md w-full h-[50px]"></span>
                  
                      <!-- Top Border Span -->
                      <!-- <span class="absolute bottom-0 left-0 right-0 -z-10 border-t-2 border-cyan-400 rounded-md w-full h-[50px]"></span> -->
                    </a>
                  </li>
                  
                  <li class="navDark flex items-center ">
                    <a class="dropdown-trigger text-gray-600 relative text-[14px] hover:text-cyan-500 transform hover:scale-105 font-bold transition-all duration-300 ease-in-out flex items-center" href="#!" data-target="dropdown1">
                      Product<span class="absolute  top-0 left-0 right-0 -z-10 border-b-2 border-cyan-400 rounded-md w-ull h-[50px]"></span>
                      <i class="material-icons right ml-2">arrow_drop_down</i>
                    </a>
                  </li>
                  <li class="navDark flex items-center">
                    <a class="dropdown-trigger text-gray-600 relative text-[14px] hover:text-cyan-500 transform hover:scale-105 font-bold transition-all duration-300 ease-in-out flex items-center" href="#!" data-target="dropdown2">
                      Service<span class="absolute  top-0 left-0 right-0 -z-10 border-b-2 border-cyan-400 rounded-md w-ull h-[53px]"></span>
                      <i class="material-icons right ml-2">arrow_drop_down</i>
                    </a>
                  </li>
                  <li class="navDark flex items-center">
                    <a class="dropdown-trigger text-gray-600 text-[14px] relative hover:text-cyan-500 transform hover:scale-105 font-bold transition-all duration-300 ease-in-out flex items-center" href="#!" data-target="dropdown3">
                      About<span class="absolute  top-0 left-0 right-0 -z-10 border-b-2 border-cyan-400 rounded-md w-ull h-[53px]"></span>
                      <i class="material-icons right ml-2">arrow_drop_down</i>
                    </a>
                  </li>
                  <li class="navDark flex items-center">
                    <a href="sass.html" class="text-gray-600 relative text-[14px] hover:text-cyan-500 transform hover:scale-105 font-bold transition-all duration-300 ease-in-out">
                      Contact<span class="absolute  top-0 left-0 right-0 -z-10 border-b-2 border-cyan-400 rounded-md w-ull h-[53px]"></span>
                    </a>
                  </li>
                </ul>
              </nav>
...
<section class="bgImage tabScren flex  flex-col-reverse lg:pb-12 md:flex-row justify-center items-center ">
   ...
   <div class=" flex flex-col  justify-end lg:pt-[200px] pb-10 md:justify-center  ">  
        ...
        <div class="md:ml-8 ml-4 rounded-lg md:pt-3 pt-8 flex gap-x-4">
          <a class="waves-effect waves-light btn  cyan darken-1 ">More</a>
          <a class="waves-effect waves-light btn  cyan darken-1">Contact US</a>
        </div>            
    </div>
